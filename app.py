    ...
    if page in ["Add Home Expense", "Add Personal Expense", "Purchase from Reserve", "Savings", "Investment"]:
        ...
        with st.form("expense_form"):
            ...
            if page == "Add Home Expense":
                category = st.selectbox("📂 Category", ("Grocery - Essential","Grocery - Non Essential", "Vegetables", "Fruits", "Gas","Fuel","Dress", "Cab", "Snacks", "Entertainment",
                ...
                category = st.selectbox("📂 Category", ("Donation", "Lent", "Loan Repayment", "Home Maint", "Personal wellness",
                                                        "Ecommerce", "Others", "Gift", "Electronics", "Furniture","Trip"), key="category_input")
            elif page == "Savings":
